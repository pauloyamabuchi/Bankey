...
class LoginViewController: UIViewController {
    ...
    weak var delegate: LoginViewControllerDelegate? // weak var avoids retain cycles
...
extension LoginViewController {
    ...
    private func style() {
        //Makes any element ready for layout
        ...
        signInButton.configuration?.imagePadding = 8 // distance between image and text in our button
...
extension LoginViewController {
    ...
    private func login() {
        ...
        if username == "Pauloyamabuchi" && password == "1234" {
